...
class SCICoNE(object):
    ...
    def detect_breakpoints(self, data=None, window_size=30, threshold=3.0, bp_limit=300, bp_min=0, lr=None, sp=None, evaluate_peaks=True, compute_lr=True, compute_sp=True, input_breakpoints=None, verbosity=1, prefix='', map_genes=True):
        if data is None:
